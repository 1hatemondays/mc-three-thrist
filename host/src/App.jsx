  ...
  return (
    <div className="host-boxes">
      ...
      <section className="host-box">
        <p>{"Pha hiện tại"}</p>
        <strong>
          {gameOver ? "Trò chơi kết thúc" : round.phase === "auction" ? "Đấu giá kín" : round.phase === "combat" ? "Đối kháng" : "Di chuyển"}
        </strong>
    ...
    <main>
      ...
      <section className="layout">
        ...
        <aside className="leaderboard">
          ...
          {rankingRows.map((team, index) => (
            <div className={"rank" + (gameOver && index === 0 ? " winner" : "")} key={team.teamId || team.id}>
